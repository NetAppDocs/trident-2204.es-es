...
* Análisis mejorado de nombres de iniciadores iSCSI. (Número [#681]
* Se ha solucionado un problema en el que no se permitían los parámetros de clase de almacenamiento CSI. (Número [#598]
* Se ha corregido la declaración de clave duplicada en Trident CRD. (Número [#671]
* Se han corregido registros de instantánea CSI imprecisos. (Número [#629]
* Se ha solucionado el problema con la anulación de la publicación de volúmenes en nodos eliminados. (Número [#691]
* Se ha añadido el tratamiento de incoherencias del sistema de archivos en dispositivos de bloque. (Número [#656]
* Se ha solucionado el problema al extraer imágenes de soporte automático al configurar el `imageRegistry` indicador durante la instalación. (Número [#715]
...
* Las conexiones entrantes con los extremos seguros de Trident ahora requieren un mínimo de TLS 1.3. (Número [#698]
...
* *Kubernetes*: El demonset de Trident ahora se ejecuta en la clase prioritaria del nodo-sistema. (Número [#694]
