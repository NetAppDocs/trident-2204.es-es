...
* Un problema común que se puede encontrar cuando se usa Trident con https://azure.microsoft.com/en-us/services/netapp/["Azure NetApp Files"] es cuando el inquilino y los secretos de cliente provienen de un registro de aplicación con permisos insuficientes. Si desea ver una lista completa de los requisitos de Trident, consulte https://docs.netapp.com/us-en/trident/trident-use/anf.html["Azure NetApp Files"] configuración.
