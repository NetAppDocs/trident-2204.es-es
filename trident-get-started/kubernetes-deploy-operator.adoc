...
* Manualmente: Trident proporciona un link:https://github.com/NetApp/trident/blob/stable/v22.04/deploy/bundle.yaml["aylma"^] archivo que se puede utilizar para instalar el operador y crear objetos asociados.
...
* Tiene privilegios completos para un clúster de Kubernetes compatible con Kubernetes 1.18 - 1.24.
